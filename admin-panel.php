...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> P&T Medical services</h2></br>
...
<html lang="en">
  ...
  <div id="logo"><a class="navbar-brand" href="#"><img src="logo.png"> P&T Medical Services </a>
...
#logo img{
 ...
 background-color: rgb(170, 140, 105)!important;
}
...
.text-primary {
    color: rgb(170, 140, 105)!important;
}
            ...
            <div class="card-body">
              ...
              document.getElementById('spec').onchange = function updateSpecs(e) {
                ...
                document.getElementById('doctor1').value = document.querySelector(`[value=${values}]`).getAttribute('data-value');
                  ...
                  <div class="col-md-4">
                    <input type="submit" name="app-submit" value="Createapp"  class="btn btn-primary" id="inputbtn" onsubmit="sendEmail()" >
...
<div class="tab-pane fade" id="app-hist" role="tabpanel" aria-labelledby="list-pat-list">
    ...
    function sendEmail() { 
      Email.send({ 
        document.getElementById("demo").innerHTML="inside email";
        Host: "smtp.gmail.com", 
        Username: "sender@email_address.com", 
        Password: "Enter your password", 
        To: 'boddireddythanmayi@gmail.com', 
        From: "ptservices24hours@gmail.com", 
